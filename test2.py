...
def answer(input_text):
    ...
    if '안녕' in input_text:
        ...
        answer_text='현재의 온도는{0}도이고 체감 온도는{1}도이에요.얼어죽기 딱 좋은 날씨죠.옷을 따뜻하게 입으세요.'.format(temperature,feel)
        ...
        answer_text='첫번째 이스터 에그를 찾으셨군요. 상품을 받아가세요.'
    elif '김민준' in input_text:
        answer_text='두번째 이스터 에그를 찾으셨군요. 상품을 받아가세요.'
